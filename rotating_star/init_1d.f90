...
module model_params
  ...
  real (kind=dp_t), parameter :: xmin = 0.d0, xmax = 1.d10
...
program init_1d
  ...
  integer, parameter :: nvar = igradr + nspec
...
1003 format(a,a)
    ...
    do i = 1, nx
       ...
       write (50,1000) xzn_hse(i), model_state(i,idens), model_state(i,itemp), &
            model_state(i,ipres), (model_state(i,ispec-1+n), n=1,nspec)
